"""
Django settings for your_professor project.
...
SECRET_KEY = 'django-insecure-c=h6!jsqpgr&v)bd34j5hpzwb=ogmq^4jv5$i9x_bytt8@%(u9'
...
ROOT_URLCONF = 'your_professor.urls'
...
WSGI_APPLICATION = 'your_professor.wsgi.application'

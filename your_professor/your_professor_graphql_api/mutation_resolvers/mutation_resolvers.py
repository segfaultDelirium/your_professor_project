...
from .mutation_resolvers_region import (resolve_update_region, resolve_reconnect_region_to_country,
                                        resolve_create_region, resolve_connect_region_to_country, resolve_delete_region)
...
mutation.set_field("connectRegionToCountry", resolve_connect_region_to_country)
